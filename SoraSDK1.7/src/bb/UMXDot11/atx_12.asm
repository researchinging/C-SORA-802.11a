...
PUBLIC	?MapQPSK_11a@@YAXPEADPEAU_COMPLEX16@@@Z		; MapQPSK_11a
PUBLIC	?InterleaveQPSK@@YAXPEBDPEAD@Z			; InterleaveQPSK
PUBLIC	?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z ; Generate12MSymbol
	ORG $+12
...
;	COMDAT ?InterleaveQPSK@@YAXPEBDPEAD@Z
_TEXT	SEGMENT
pbInput$ = 8
pbOutput$ = 16
?InterleaveQPSK@@YAXPEBDPEAD@Z PROC			; InterleaveQPSK, COMDAT

; 31   :     unsigned int * puiOutput = (unsigned int *) pbOutput;
; 32   :     const unsigned int * puiInterleaveMask
; 33   :         = INTERLEAVE_12M((unsigned char)(pbInput[0]));

	movzx	eax, BYTE PTR [rcx]
	lea	r10, OFFSET FLAT:INTERLEAVE_12M_LUT
...
; 34   :     unsigned int j;
; 35   : 
; 36   :     puiOutput[0] = puiInterleaveMask[0];

	mov	eax, DWORD PTR [r10+r9*4]
	mov	DWORD PTR [rdx], eax

; 37   :     puiOutput[1] = puiInterleaveMask[1];

	mov	eax, DWORD PTR [r10+r9*4+4]
	mov	DWORD PTR [rdx+4], eax

; 38   :     puiOutput[2] = puiInterleaveMask[2];
...
; 40   :     for (j = 1; j < 12; j++)
; 41   :     {
; 42   :         puiInterleaveMask = INTERLEAVE_12M((j << 8) 
; 43   :                 + (unsigned char)(pbInput[j]));
...
; 44   : 
; 45   :         puiOutput[0] |= puiInterleaveMask[0];

	mov	eax, DWORD PTR [r10+rax*4]
	or	DWORD PTR [rdx], eax

; 46   :         puiOutput[1] |= puiInterleaveMask[1];

	mov	eax, DWORD PTR [r10+rcx*4+4]
	or	DWORD PTR [rdx+4], eax

; 47   :         puiOutput[2] |= puiInterleaveMask[2];

	mov	eax, DWORD PTR [r10+rcx*4+8]
	or	DWORD PTR [rdx+8], eax
	cmp	r8d, 3072				; 00000c00H
	jb	SHORT $LL3@Interleave@3

; 48   :     }
; 49   : }

	fatret	0
?InterleaveQPSK@@YAXPEBDPEAD@Z ENDP			; InterleaveQPSK
; Function compile flags: /Ogtpy
; File c:\sorasdk1.7\src\bb\dot11a\inc\bb\mod\amap.h
_TEXT	ENDS
;	COMDAT ?MapQPSK_11a@@YAXPEADPEAU_COMPLEX16@@@Z
_TEXT	SEGMENT
pbInput$ = 8
pcOutput$ = 16
?MapQPSK_11a@@YAXPEADPEAU_COMPLEX16@@@Z PROC		; MapQPSK_11a, COMDAT

; 24   :     unsigned int i;
; 25   :     const COMPLEX16 * pcLUT;
; 26   : 
; 27   :     for (i = 0; i < 12; i++)

	lea	r8, QWORD PTR [rcx+1]
	mov	r9d, 2
	lea	r10, OFFSET FLAT:MAPA_QPSK_LUT
	npad	15
$LL3@MapQPSK_11:

; 28   :     {
; 29   :         pcLUT = MAPA_QPSK((unsigned char)(pbInput[i]));

	movzx	eax, BYTE PTR [r8-1]

; 30   :         pcOutput[0] = pcLUT[0];
; 31   :         pcOutput[1] = pcLUT[1];
; 32   :         pcOutput[2] = pcLUT[2];
; 33   :         pcOutput[3] = pcLUT[3];
...
; 36   : }
	...
	fatret	0
?MapQPSK_11a@@YAXPEADPEAU_COMPLEX16@@@Z ENDP		; MapQPSK_11a
;	COMDAT pdata
; File c:\sorasdk1.7\inc\vector128.h
pdata	SEGMENT
$pdata$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z DD imagerel $LN1041
	DD	imagerel $LN1041+40
	DD	imagerel $unwind$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$0$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z DD imagerel $LN1041+40
	DD	imagerel $LN1041+1581
	DD	imagerel $chain$0$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$1$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z DD imagerel $LN1041+1581
	DD	imagerel $LN1041+1589
	DD	imagerel $chain$1$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$10$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z DD imagerel $LN1041+1589
	DD	imagerel $LN1041+2832
	DD	imagerel $chain$10$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$11$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z DD imagerel $LN1041+2832
	DD	imagerel $LN1041+2967
	DD	imagerel $chain$11$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z
pdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$chain$11$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z DD 021H
	DD	imagerel $LN1041+1581
	DD	imagerel $LN1041+1589
	DD	imagerel $chain$1$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$chain$10$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z DD 012c321H
	DD	023e8c3H
	DD	024d8a0H
	DD	025c88eH
	DD	026b871H
...
;	COMDAT xdata
xdata	SEGMENT
$chain$1$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z DD 021H
	DD	imagerel $LN1041
	DD	imagerel $LN1041+40
	DD	imagerel $unwind$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$chain$0$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z DD 020821H
	DD	05c5408H
	DD	imagerel $LN1041
	DD	imagerel $LN1041+40
	DD	imagerel $unwind$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z DD 071001H
	DD	05f3410H
	DD	0580110H
	DD	07007c009H
	DD	06006H
...
xdata	ENDS
;	COMDAT ?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z
_TEXT	SEGMENT
rr1$1601923 = 32
temp$1596360 = 48
info$ = 736
...
pbData$ = 760
bPilotSgn$ = 768
?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z PROC ; Generate12MSymbol, COMDAT
...
; 148  :     ConvEncode_1_2(pbData, info->bEncoded, 6, info->bConvEncoderReg);
...
; 149  :     InterleaveQPSK(info->bEncoded, info->bInterleaved);
	...
	mov	WORD PTR TxVector+35, ax
	movzx	eax, BYTE PTR TxVector+25
	lea	eax, DWORD PTR [rax+rax*2]
	cdqe
	mov	r8d, DWORD PTR INTERLEAVE_12M_LUT[r12+rax*4]
	mov	r9d, DWORD PTR INTERLEAVE_12M_LUT[r12+rax*4+4]
	mov	r10d, DWORD PTR INTERLEAVE_12M_LUT[r12+rax*4+8]
...
$LL10@Generate12:
	...
	lea	eax, DWORD PTR [rax+rax*2]
	or	r8d, DWORD PTR INTERLEAVE_12M_LUT[r12+rax*4]
	or	r9d, DWORD PTR INTERLEAVE_12M_LUT[r12+rax*4+4]
	or	r10d, DWORD PTR INTERLEAVE_12M_LUT[r12+rax*4+8]
	mov	DWORD PTR TxVector+61, r8d
	mov	DWORD PTR TxVector+65, r9d
	mov	DWORD PTR TxVector+69, r10d
	cmp	edx, 3072				; 00000c00H
	jb	SHORT $LL10@Generate12

; 150  :     MapQPSK_11a(info->bInterleaved, info->cMapped);
...
$LL15@Generate12:
	...
	shl	eax, 2
	movsxd	rcx, eax
	mov	eax, DWORD PTR MAPA_QPSK_LUT[r12+rcx*4]
	mov	DWORD PTR [rdx-104], eax
	mov	eax, DWORD PTR MAPA_QPSK_LUT[r12+rcx*4+4]
	mov	DWORD PTR [rdx-100], eax
	mov	eax, DWORD PTR MAPA_QPSK_LUT[r12+rcx*4+8]
	mov	DWORD PTR [rdx-96], eax
	mov	eax, DWORD PTR MAPA_QPSK_LUT[r12+rcx*4+12]
	mov	DWORD PTR [rdx-92], eax
	movzx	eax, BYTE PTR [r8-6]
	shl	eax, 2
	movsxd	rcx, eax
...
; 151  : 
; 152  :     AddPilot(info->cMapped, info->cPilotAdded, bPilotSgn);
...
$LN28@Generate12:
	...
	jb	SHORT $LL29@Generate12
	mov	edx, 1
	lea	r8, OFFSET FLAT:TxVector+308
	npad	6
$LL24@Generate12:
	cmp	edx, 7
	je	SHORT $LN23@Generate12
	cmp	edx, 21
	je	SHORT $LN23@Generate12
	mov	eax, DWORD PTR [rcx]
	add	rcx, 4
...
$LN23@Generate12:
	...
	add	r8, 4
	cmp	edx, 26
	jbe	SHORT $LL24@Generate12
	cmp	BYTE PTR bPilotSgn$[rsp], 0
	jne	SHORT $LN19@Generate12
	xor	esi, esi
...
; 153  :     IFFT64x(info->cPilotAdded, info->cSymbol + COMPLEX_GI);

	lea	rcx, QWORD PTR temp$1596360[rsp]
	xor	edx, edx
	...
	call	memcpy
	lea	rcx, QWORD PTR temp$1596360[rsp+384]
...
$LL39@Generate12:
	...
	add	r11, 8
	cmp	rdx, r8
	mov	ecx, DWORD PTR temp$1596360[rsp+rax*4]
...
$LL36@Generate12:
	...
	jne	SHORT $LL36@Generate12

; 154  : 
; 155  :     CopyGI(info->cSymbol, info->cSymbol + 128);
...
; 156  :     Window(info->cSymbol, pcLast);
...
; 157  :     return UpsampleAndCopyNT(info, pcOutput, info->cSymbol, COMPLEX_PER_OFDM_SYMBOL);
...
$LL83@Generate12:
	...
	movdqa	XMMWORD PTR rr1$1601923[rsp], xmm3
	mov	eax, DWORD PTR rr1$1601923[rsp]
	mov	DWORD PTR [rcx], eax
	mov	eax, DWORD PTR rr1$1601923[rsp+4]
	mov	DWORD PTR [rcx+4], eax
	mov	eax, DWORD PTR rr1$1601923[rsp+8]
...
$LL920@Generate12:
	...
	jne	SHORT $LL920@Generate12
	mov	eax, 176				; 000000b0H
	jmp	SHORT $LN72@Generate12
$LN78@Generate12:
	cmp	eax, 40					; 00000028H
	jne	SHORT $LN73@Generate12
	mov	eax, 20
	npad	5
$LL965@Generate12:
...
; 158  : }
	...
	pop	rsi
	ret	0
?Generate12MSymbol@@YAIPEAU_BB11A_TX_VECTOR@@PEAU_COMPLEX8@@PEAU_COMPLEX16@@PEADE@Z ENDP ; Generate12MSymbol
PUBLIC	?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z ; Dot11aTxFrameEncode12
;	COMDAT pdata
; File c:\sorasdk1.7\inc\vector128.h
pdata	SEGMENT
$pdata$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z DD imagerel $LN3305
	DD	imagerel $LN3305+11
	DD	imagerel $unwind$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$15$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z DD imagerel $LN3305+11
	DD	imagerel $LN3305+284
	DD	imagerel $chain$15$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$16$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z DD imagerel $LN3305+284
	DD	imagerel $LN3305+1475
	DD	imagerel $chain$16$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$17$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z DD imagerel $LN3305+1475
	DD	imagerel $LN3305+6711
	DD	imagerel $chain$17$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$18$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z DD imagerel $LN3305+6711
	DD	imagerel $LN3305+6887
	DD	imagerel $chain$18$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z
pdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$chain$18$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z DD 021H
	DD	imagerel $LN3305
	DD	imagerel $LN3305+11
	DD	imagerel $unwind$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$chain$17$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z DD 021H
	DD	imagerel $LN3305+11
	DD	imagerel $LN3305+284
	DD	imagerel $chain$15$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$chain$16$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z DD 020921H
	DD	025f809H
	DD	imagerel $LN3305+11
	DD	imagerel $LN3305+284
	DD	imagerel $chain$15$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z
...
;	COMDAT xdata
xdata	SEGMENT
$chain$15$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z DD 020f121H
	DD	026e8f1H
	DD	027d8e8H
	DD	028c8dfH
	DD	029b8d6H
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z DD 030b01H
	DD	062010bH
	DD	03004H
; Function compile flags: /Ogtpy
; File c:\sorasdk1.7\src\bb\dot11a\dot11\atx_tpl_imp.h
xdata	ENDS
;	COMDAT ?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z
_TEXT	SEGMENT
rgbSignal$2873925 = 32
$T2875087 = 32
pcOutput$ = 40
rr1$2882011 = 48
rr1$2874254 = 48
...
info$ = 800
pPacket$ = 808
?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z PROC ; Dot11aTxFrameEncode12, COMDAT
...
$LL25@Dot11aTxFr@7:
	...
	pand	xmm1, xmm8
	por	xmm2, xmm1
	jne	$LL25@Dot11aTxFr@7
	movdqa	XMMWORD PTR rr1$2865028[rsp], xmm2
	mov	eax, DWORD PTR rr1$2865028[rsp]
	lea	edx, QWORD PTR [rdi+22]
	mov	DWORD PTR [rcx], eax
	mov	eax, DWORD PTR rr1$2865028[rsp+4]
	mov	DWORD PTR [rcx+4], eax
	mov	eax, DWORD PTR rr1$2865028[rsp+8]
	mov	DWORD PTR [rcx+8], eax
	mov	rax, r14
	mov	rcx, r11
	npad	4
$LL862@Dot11aTxFr@7:
	...
	jne	SHORT $LL862@Dot11aTxFr@7
	add	r11, 352				; 00000160H
	add	r9, rbx
	sub	r10, 1
	jne	$LL19@Dot11aTxFr@7
	mov	r11, QWORD PTR pcOutput$[rsp]
	movaps	xmm15, XMMWORD PTR [rsp+592]
	mov	ebx, 704				; 000002c0H
	jmp	SHORT $LN14@Dot11aTxFr@7
$LN20@Dot11aTxFr@7:
	cmp	eax, 40					; 00000028H
	jne	SHORT $LN15@Dot11aTxFr@7
...
; 36   :             (unsigned short)PacketSizePlusCRC32);
	...
	mov	eax, ecx
	lea	r10, QWORD PTR rgbSignal$2873925[rsp]
	mov	r11d, 3
	shr	eax, 4
	...
	shl	eax, 16
	or	eax, edx
	mov	DWORD PTR rgbSignal$2873925[rsp], eax
	npad	5
$LL960@Dot11aTxFr@7:
...
$LL970@Dot11aTxFr@7:
	...
	jne	SHORT $LL970@Dot11aTxFr@7
	mov	rcx, r10
	mov	edx, 38					; 00000026H
	lea	r8, OFFSET FLAT:TxVector+456
$LL984@Dot11aTxFr@7:
	cmp	edx, 57					; 00000039H
	je	SHORT $LN983@Dot11aTxFr@7
	cmp	edx, 43					; 0000002bH
	je	SHORT $LN983@Dot11aTxFr@7
	mov	eax, DWORD PTR [rcx]
	add	rcx, 4
...
$LN983@Dot11aTxFr@7:
	...
	add	r8, 4
	cmp	edx, 64					; 00000040H
	jb	SHORT $LL984@Dot11aTxFr@7
	mov	edx, 1
	lea	r8, OFFSET FLAT:TxVector+308
$LL979@Dot11aTxFr@7:
	cmp	edx, 7
	je	SHORT $LN978@Dot11aTxFr@7
	cmp	edx, 21
	je	SHORT $LN978@Dot11aTxFr@7
	mov	eax, DWORD PTR [rcx]
	add	rcx, 4
...
$LN978@Dot11aTxFr@7:
	...
	add	r8, 4
	cmp	edx, 26
	jbe	SHORT $LL979@Dot11aTxFr@7
	mov	eax, 10720				; 000029e0H
	mov	ecx, -10720				; ffffffffffffd620H
	xor	edx, edx
	mov	WORD PTR TxVector+388, cx
	lea	rcx, QWORD PTR temp$2874093[rsp]
	mov	r8d, 512				; 00000200H
	mov	WORD PTR TxVector+332, ax
	...
	mov	r8d, 128				; 00000080H
	call	memcpy
	lea	rcx, QWORD PTR temp$2874093[rsp+384]
	lea	rdx, OFFSET FLAT:TxVector+432
	mov	r8d, 128				; 00000080H
	call	memcpy
	lea	rcx, QWORD PTR temp$2874093[rsp]
...
$LL994@Dot11aTxFr@7:
	...
	add	r8, 4
	cmp	rdx, r9
	mov	ecx, DWORD PTR temp$2874093[rsp+rax*4]
	mov	DWORD PTR [r8-4], ecx
	jl	SHORT $LL994@Dot11aTxFr@7
	mov	rax, r11
	mov	ecx, 32					; 00000020H
$LL991@Dot11aTxFr@7:
	movdqa	xmm0, XMMWORD PTR [rax]
...
$LL1038@Dot11aTxFr@7:
	...
	pand	xmm1, xmm8
	por	xmm3, xmm1
	jne	$LL1038@Dot11aTxFr@7
	movdqa	XMMWORD PTR rr1$2874254[rsp], xmm3
	mov	eax, DWORD PTR rr1$2874254[rsp]
	mov	DWORD PTR [rcx], eax
	mov	eax, DWORD PTR rr1$2874254[rsp+4]
	mov	DWORD PTR [rcx+4], eax
	mov	eax, DWORD PTR rr1$2874254[rsp+8]
	mov	DWORD PTR [rcx+8], eax
	lea	rax, OFFSET FLAT:TxVector+1200
	lea	ecx, QWORD PTR [r8+22]
	npad	2
$LL1875@Dot11aTxFr@7:
	...
	packsswb xmm1, xmm0
	movntdq	XMMWORD PTR [rbx-16], xmm1
	jne	SHORT $LL1875@Dot11aTxFr@7
	mov	eax, 176				; 000000b0H
	jmp	SHORT $LN1027@Dot11aTxFr@7
$LN1033@Dot11aTxFr@7:
	cmp	eax, 40					; 00000028H
	jne	SHORT $LN1028@Dot11aTxFr@7
	mov	rax, rdi
	mov	ecx, 20
	npad	2
$LL1920@Dot11aTxFr@7:
...
; 40   :             uiSymbolCountData * (DBPS / BITS_PER_BYTE), pPacket->Reserved1, info->ulRadom);
	...
	lea	eax, DWORD PTR [rbp+rbp*2]
	mov	DWORD PTR $T2875087[rsp], esi
...
$LL1967@Dot11aTxFr@7:
	...
	jne	SHORT $LL1967@Dot11aTxFr@7
$LN1965@Dot11aTxFr@7:
	mov	r10, QWORD PTR [r10]
	test	r10, r10
	jne	SHORT $LL1969@Dot11aTxFr@7
$LN1968@Dot11aTxFr@7:
	movzx	eax, r8b
	add	rdx, 5
	shr	rax, 1
	...
	movzx	ecx, BYTE PTR SCRAMBLE_11A_LUT[rax+r14]
	movzx	eax, cl
	xor	al, BYTE PTR $T2875087[rsp+1]
	mov	BYTE PTR [rdx-4], al
	mov	rax, rcx
	shr	rax, 1
	movzx	ecx, BYTE PTR SCRAMBLE_11A_LUT[rax+r14]
	movzx	eax, cl
	xor	al, BYTE PTR $T2875087[rsp+2]
	mov	BYTE PTR [rdx-3], al
	mov	rax, rcx
	shr	rax, 1
	movzx	ecx, BYTE PTR SCRAMBLE_11A_LUT[rax+r14]
	movzx	eax, cl
	xor	al, BYTE PTR $T2875087[rsp+3]
...
$LL1978@Dot11aTxFr@7:
	...
	sub	r9, 1
	mov	BYTE PTR TxVector+24, al
	jne	SHORT $LL1978@Dot11aTxFr@7
	movzx	eax, BYTE PTR TxVector+25
	mov	edx, 256				; 00000100H
	lea	r11, OFFSET FLAT:TxVector+26
	lea	eax, DWORD PTR [rax+rax*2]
	cdqe
	mov	r8d, DWORD PTR INTERLEAVE_12M_LUT[r14+rax*4]
	mov	r9d, DWORD PTR INTERLEAVE_12M_LUT[r14+rax*4+4]
	mov	r10d, DWORD PTR INTERLEAVE_12M_LUT[r14+rax*4+8]
	mov	DWORD PTR TxVector+61, r8d
	mov	DWORD PTR TxVector+65, r9d
	mov	DWORD PTR TxVector+69, r10d
	npad	5
$LL1983@Dot11aTxFr@7:
	...
	add	edx, 256				; 00000100H
	lea	eax, DWORD PTR [rax+rax*2]
	or	r8d, DWORD PTR INTERLEAVE_12M_LUT[r14+rax*4]
	or	r9d, DWORD PTR INTERLEAVE_12M_LUT[r14+rax*4+4]
	or	r10d, DWORD PTR INTERLEAVE_12M_LUT[r14+rax*4+8]
	mov	DWORD PTR TxVector+61, r8d
	mov	DWORD PTR TxVector+65, r9d
	mov	DWORD PTR TxVector+69, r10d
	cmp	edx, 3072				; 00000c00H
	jb	SHORT $LL1983@Dot11aTxFr@7
	lea	rdx, OFFSET FLAT:TxVector+120
	lea	r8, OFFSET FLAT:TxVector+61
	mov	r9d, 12
	npad	5
$LL1988@Dot11aTxFr@7:
	...
	sub	r9, 1
	movsxd	rcx, eax
	mov	eax, DWORD PTR MAPA_QPSK_LUT[r14+rcx*4]
	mov	DWORD PTR [rdx-24], eax
	mov	eax, DWORD PTR MAPA_QPSK_LUT[r14+rcx*4+4]
	mov	DWORD PTR [rdx-20], eax
	mov	eax, DWORD PTR MAPA_QPSK_LUT[r14+rcx*4+8]
	mov	DWORD PTR [rdx-16], eax
	mov	eax, DWORD PTR MAPA_QPSK_LUT[r14+rcx*4+12]
	mov	DWORD PTR [rdx-12], eax
	jne	SHORT $LL1988@Dot11aTxFr@7
	lea	rcx, OFFSET FLAT:TxVector+112
	mov	edx, 38					; 00000026H
	lea	r8, OFFSET FLAT:TxVector+456
$LL2002@Dot11aTxFr@7:
	cmp	edx, 57					; 00000039H
	je	SHORT $LN2001@Dot11aTxFr@7
	cmp	edx, 43					; 0000002bH
	je	SHORT $LN2001@Dot11aTxFr@7
	mov	eax, DWORD PTR [rcx]
	add	rcx, 4
...
$LN2001@Dot11aTxFr@7:
	...
	add	r8, 4
	cmp	edx, 64					; 00000040H
	jb	SHORT $LL2002@Dot11aTxFr@7
	mov	edx, 1
	lea	r8, OFFSET FLAT:TxVector+308
$LL1997@Dot11aTxFr@7:
	cmp	edx, 7
	je	SHORT $LN1996@Dot11aTxFr@7
	cmp	edx, 21
	je	SHORT $LN1996@Dot11aTxFr@7
	mov	eax, DWORD PTR [rcx]
	add	rcx, 4
...
$LN1996@Dot11aTxFr@7:
	...
	add	r8, 4
	cmp	edx, 26
	jbe	SHORT $LL1997@Dot11aTxFr@7
	cmp	BYTE PTR PILOTSGN_LUT[rsi+r14], r15b
	jne	SHORT $LN1992@Dot11aTxFr@7
	mov	eax, 10720				; 000029e0H
	mov	ecx, -10720				; ffffffffffffd620H
	mov	WORD PTR TxVector+334, r15w
	mov	WORD PTR TxVector+390, r15w
...
$LN1992@Dot11aTxFr@7:
	...
	mov	WORD PTR TxVector+476, cx
$LN2016@Dot11aTxFr@7:
	lea	rcx, QWORD PTR temp$2882887[rsp]
	xor	edx, edx
	mov	r8d, 512				; 00000200H
	call	memset
	lea	rcx, QWORD PTR temp$2882887[rsp]
	...
	mov	r8d, 128				; 00000080H
	call	memcpy
	lea	rcx, QWORD PTR temp$2882887[rsp+384]
	lea	rdx, OFFSET FLAT:TxVector+432
	mov	r8d, 128				; 00000080H
	call	memcpy
	lea	rcx, QWORD PTR temp$2882887[rsp]
...
$LL2012@Dot11aTxFr@7:
	...
	add	r11, 4
	cmp	rdx, r12
	mov	ecx, DWORD PTR temp$2882887[rsp+rax*4]
	mov	DWORD PTR [r11-4], ecx
	jl	SHORT $LL2012@Dot11aTxFr@7
	mov	rax, r8
	mov	ecx, 32					; 00000020H
$LL2009@Dot11aTxFr@7:
	movdqa	xmm0, XMMWORD PTR [rax]
...
$LL2056@Dot11aTxFr@7:
	...
	pand	xmm1, xmm8
	por	xmm3, xmm1
	jne	$LL2056@Dot11aTxFr@7
	movdqa	XMMWORD PTR rr1$2882011[rsp], xmm3
	mov	eax, DWORD PTR rr1$2882011[rsp]
	mov	DWORD PTR [rcx], eax
	mov	eax, DWORD PTR rr1$2882011[rsp+4]
	mov	DWORD PTR [rcx+4], eax
	mov	eax, DWORD PTR rr1$2882011[rsp+8]
	mov	DWORD PTR [rcx+8], eax
	lea	rax, OFFSET FLAT:TxVector+1200
	lea	ecx, QWORD PTR [r8+22]
$LL2893@Dot11aTxFr@7:
	...
	packsswb xmm1, xmm0
	movntdq	XMMWORD PTR [rbx-16], xmm1
	jne	SHORT $LL2893@Dot11aTxFr@7
	mov	eax, 176				; 000000b0H
	jmp	SHORT $LN2045@Dot11aTxFr@7
$LN2051@Dot11aTxFr@7:
	cmp	DWORD PTR TxVector, 40			; 00000028H
	jne	SHORT $LN2046@Dot11aTxFr@7
...
; 45   :     for (i = 0; i < uiSymbolCountData; i++)
	...
	sub	rbp, 1
	je	SHORT $LN3304@Dot11aTxFr@7

; 41   : 
; 42   :     ConvEncodeReset(info->bConvEncoderReg);

	mov	al, BYTE PTR TxVector+24
	jmp	$LL4@Dot11aTxFr@7
$LN3304@Dot11aTxFr@7:
...
; 58   : }
	...
	pop	rbx
	ret	0
?Dot11aTxFrameEncode12@@YAJPEAU_BB11A_TX_VECTOR@@PEAU__PACKET_BASE@@@Z ENDP ; Dot11aTxFrameEncode12
END
