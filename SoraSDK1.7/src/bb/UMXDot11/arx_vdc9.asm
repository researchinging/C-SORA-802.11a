...
PUBLIC	??$NeedNewDescriptor@$08@@YA_NH@Z		; NeedNewDescriptor<9>
PUBLIC	??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z ; VitDesCRC<9,3,72,72,VB<48,128> >
	ORG $+12
...
;	COMDAT ??$NeedNewDescriptor@$08@@YA_NH@Z
_TEXT	SEGMENT
iTrellis$ = 8
??$NeedNewDescriptor@$08@@YA_NH@Z PROC			; NeedNewDescriptor<9>, COMDAT

; 9    : template<> inline bool NeedNewDescriptor<9>(int iTrellis) { return iTrellis == 36 || iTrellis == 72|| iTrellis == 108|| iTrellis == 144; }

	cmp	ecx, 36					; 00000024H
	je	SHORT $LN3@NeedNewDes@2
...
$LN3@NeedNewDes@2:
	mov	al, 1
	ret	0
??$NeedNewDescriptor@$08@@YA_NH@Z ENDP			; NeedNewDescriptor<9>
;	COMDAT pdata
; File c:\sorasdk1.7\inc\crc32.h
pdata	SEGMENT
$pdata$??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z DD imagerel $LN3221
	DD	imagerel $LN3221+239
	DD	imagerel $unwind$??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$1$??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z DD imagerel $LN3221+239
	DD	imagerel $LN3221+3055
	DD	imagerel $chain$1$??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$2$??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z DD imagerel $LN3221+3055
	DD	imagerel $LN3221+3081
	DD	imagerel $chain$2$??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z
pdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$chain$2$??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z DD 021H
	DD	imagerel $LN3221
	DD	imagerel $LN3221+239
	DD	imagerel $unwind$??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$chain$1$??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z DD 041021H
	DD	016e410H
	DD	0156408H
	DD	imagerel $LN3221
	DD	imagerel $LN3221+239
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z DD 0a2701H
	DD	066827H
	DD	0173411H
	DD	0f00dd211H
	DD	0c009d00bH
...
; File c:\sorasdk1.7\src\bb\dot11a\dot11\arx_vdc.h
xdata	ENDS
;	COMDAT ??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z
_TEXT	SEGMENT
uiBitsTotal$1$ = 0
bSeed$ = 4
i_trellis$1$ = 8
...
pRxContextA$ = 160
vb$ = 168
??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z PROC ; VitDesCRC<9,3,72,72,VB<48,128> >, COMDAT
...
; 248  :     while (blkInputStart->isValid == 0 && fWork)
	...
	mov	r11d, ebx
	test	al, al
	jne	SHORT $LN3216@VitDesCRC@5
	npad	3
$LL33@VitDesCRC@5:
	movzx	eax, BYTE PTR [rdi]
	test	al, al
	je	SHORT $LN3216@VitDesCRC@5
...
; 270  :             i_trellis += 3;
	...
	mov	DWORD PTR i_trellis$1$[rsp], r11d
	punpckhbw xmm0, xmm0
	punpckhbw xmm2, xmm2
...
; 305  :             if (NeedNewDescriptor<MBitRate>(i_trellis))
	...
	je	SHORT $LN2302@VitDesCRC@5
	cmp	r11d, 72				; 00000048H
	je	SHORT $LN2302@VitDesCRC@5
	cmp	r11d, 108				; 0000006cH
	je	SHORT $LN2302@VitDesCRC@5
	cmp	r11d, 144				; 00000090H
	jne	SHORT $LN22@VitDesCRC@5
$LN2302@VitDesCRC@5:
...
; 316  :                 while (blkInputStart->isValid == 0 && fWork)
	...
	test	al, al
	jne	SHORT $LN3217@VitDesCRC@5
	npad	6
$LL20@VitDesCRC@5:
	movzx	eax, BYTE PTR [rdi]
	test	al, al
	je	SHORT $LN3217@VitDesCRC@5
...
; 327  :         if ( i_trellis >= TB_DEPTH_ + TB_OUTPUT_ + TB_PREFIX )
	...
	cmp	r11d, 150				; 00000096H
	jl	$LN3218@VitDesCRC@5
...
; 256  :     while (uiBitsTotal)
	...
	test	eax, eax
	jne	$LL30@VitDesCRC@5
	mov	r9, QWORD PTR pRxContextA$GSCopy$1$[rsp]
	jmp	SHORT $LN29@VitDesCRC@5
$LN3215@VitDesCRC@5:
	mov	r14d, DWORD PTR uiCrc32Store$[rsp]
$LN29@VitDesCRC@5:
...
; 479  : }
	...
	pop	rbp
	ret	0
??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z ENDP ; VitDesCRC<9,3,72,72,VB<48,128> >
_TEXT	ENDS
PUBLIC	?VitDesCRC9@@YAXPEAU_BB11A_RX_CONTEXT@@@Z	; VitDesCRC9
; Function compile flags: /Ogtpy
; File c:\sorasdk1.7\src\bb\dot11a\dot11\arx_vdc9.c
;	COMDAT ?VitDesCRC9@@YAXPEAU_BB11A_RX_CONTEXT@@@Z
_TEXT	SEGMENT
pRxContextA$ = 8
?VitDesCRC9@@YAXPEAU_BB11A_RX_CONTEXT@@@Z PROC		; VitDesCRC9, COMDAT

; 12   :     VitDesCRC<9, NOR_MASK, TB_DEPTH, TB_OUTPUT>
...
; 14   : }
	...
	jmp	??$VitDesCRC@$08$02$0EI@$0EI@U?$VB@$0DA@$0IA@@@@@YAXPEAU_BB11A_RX_CONTEXT@@AEAU?$VB@$0DA@$0IA@@@@Z ; VitDesCRC<9,3,72,72,VB<48,128> >
?VitDesCRC9@@YAXPEAU_BB11A_RX_CONTEXT@@@Z ENDP		; VitDesCRC9
END
